...
var DataCell = function (_React$Component) {
  ...
  function DataCell(props) {
    ...
    _this.state = { updated: false, reverting: false, value: props.cell.value, committing: false };
    return _this;
  }
  ...
  _createClass(DataCell, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState, nextContext) {
      if (nextProps.selected !== this.props.selected) return true;else if (nextProps.editing !== this.props.editing) return true;else if (nextState.value !== this.state.value) return true;else if (nextState.updated !== this.state.updated) return true;
      return false;
    }
  }, {
